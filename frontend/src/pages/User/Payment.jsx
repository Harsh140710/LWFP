    ...
    <div className="lg:col-span-2 bg-[#080808] border border-white/5 p-8 shadow-2xl">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <input required name="email" type="email" placeholder="Email Address" value={userDetails.email} onChange={handleChange} className="bg-transparent border-b border-white/10 p-3 focus:border-[#A37E2C] outline-none transition-colors text-sm text-white" />
