      ...
      <section className="py-64 bg-[#050505]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-0 border-t border-b border-white/5">
          {[
            ...
            { name: "Yacht-Master Gold", ref: "YM-110", price: "$28,900", img: "https://images.pexels.com/photos/266666/pexels-photo-266666.jpeg?cs=srgb&dl=pexels-pixabay-266666.jpg&fm=jpg" },
