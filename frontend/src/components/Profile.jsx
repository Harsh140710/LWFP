...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 dark:bg-[#0B0B0D] px-4 py-8">
        ...
        <div className="flex flex-col items-center gap-4">
          <label className="relative cursor-pointer group">
            <img
              src={userData.avatar}
              alt="profile"
              className="rounded-full h-28 w-28 object-cover border-4 border-[#B48E57] transition group-hover:opacity-70"
            />
            <input
              type="file"
              accept="image/*"
