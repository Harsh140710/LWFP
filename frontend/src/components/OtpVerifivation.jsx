...
const OTPVerification = () => {
  ...
  return (
    <div className="flex h-[calc(100vh-74px)] flex-col items-center justify-center bg-[#F9FAFB] dark:bg-[#0B0B0D]">
      <div className=" p-10 rounded-2xl flex items-center justify-center flex-col shadow-lg bg-[#FFFFFF] dark:bg-[#101012]">
